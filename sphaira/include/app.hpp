...
// private:
    static constexpr inline auto CONFIG_PATH = "/config/mm-tools/config.ini";
    static constexpr inline auto PLAYLOG_PATH = "/config/mm-tools/playlog.ini";
    ...
    option::OptionString m_default_music{INI_SECTION, "default_music", "/config/mm-tools/themes/default_music.bfstm"};
    ...
    option::OptionString m_pack_url{"pack", "pack_url", "file:///config/mm-tools/releases.json"};

    // Installer options (HATS installer payload)
    option::OptionString m_installer_payload{"installer", "payload", "/switch/mm-tools/hats-installer.bin"};
    option::OptionString m_installer_staging_path{"installer", "staging_path", "/config/mm-tools/hats-staging"};
