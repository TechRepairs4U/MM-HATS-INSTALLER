...
private:
    ...
    static constexpr inline fs::FsPath JSON_PATH{"/switch/mm-tools/cache/etag_v2.json"};
...
void GetDownloadTempPath(fs::FsPath& buf) {
    ...
    std::snprintf(buf, sizeof(buf), "/switch/mm-tools/cache/download_temp%lu", count_copy);
}
