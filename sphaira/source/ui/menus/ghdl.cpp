...
constexpr auto CACHE_PATH = "/switch/mm-tools/cache/github";
...
auto DownloadApp(ProgressBox* pbox, const GhApiAsset& gh_asset, const AssetEntry* entry) -> Result {
    static const fs::FsPath temp_file{"/switch/mm-tools/cache/github/ghdl.temp"};
...
void Menu::Scan() {
    ...
    LoadEntriesFromPath("/config/mm-tools/github/");
    Sort();
    SetIndex(0);
}
