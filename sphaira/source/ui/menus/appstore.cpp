...
constexpr fs::FsPath REPO_PATH{"/switch/mm-tools/cache/appstore/repo.json"};
constexpr fs::FsPath CACHE_PATH{"/switch/mm-tools/cache/appstore"};
...
auto InstallApp(ProgressBox* pbox, const Entry& entry) -> Result {
    static const fs::FsPath zip_out{"/switch/mm-tools/cache/appstore/temp.zip"};
...
Menu::Menu(u32 flags) : grid::Menu{"AppStore"_i18n, flags} {
    fs::FsNativeSd fs;
    fs.CreateDirectoryRecursively("/switch/mm-tools/cache/appstore/icons");
    fs.CreateDirectoryRecursively("/switch/mm-tools/cache/appstore/banners");
    fs.CreateDirectoryRecursively("/switch/mm-tools/cache/appstore/screens");
